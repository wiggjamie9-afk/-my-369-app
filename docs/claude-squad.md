...
> Demo: https://github.com/user-attachments/assets/aef18253-e58f-4525-9032-f5a3d66c975a
...
If you get an error like `failed to start new session: timed out waiting for tmux session`, update the underlying program (e.g. `claude`) to the latest version.
