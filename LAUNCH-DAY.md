...
| Launch email | `SALES-LISTINGS.md` (bottom) | 1 |
...
- [ ] Create the **launch 3** first: **Present, Not Perfect** ($9), **Dad's Code Kitchen** ($9 intro), **Days Left** (free).
...
- [ ] *(After launch)* add the other 15 + the 4 bundles.
...
- [ ] Record + upload episodes (scripts in `DADS-CODE-READ-ALOUD.md`). Lead with **"How Many Bedtimes Left?"**
...
- **Day 1:** launch 3 products + free tool + 3 posts + email.
- **Day 2–3:** add the rest of the 18 + the 4 bundles to Gumroad.
- **Day 3:** publish podcast episode 2.
- **Day 4–7:** post 1 promo clip/day; reply to every comment.
- **This week:** start Amazon KDP with **Present, Not Perfect** (see `KDP-SETUP.md`).
